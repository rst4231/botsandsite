...
import { sendPreparedPreview } from '../../../../lib/private-preview.mjs';

const cache = getCache({ namespace: 'traffic-news-v4' });
const CHAT_ID = '160628165';
const EXPECTED_KEY_HASH = '9433a8a05e68a281310cea546e4b5d07fcb2f2e7287849bfc2f591c89beb7a62';
...
export async function GET(request) {
  ...
  if (alreadySent?.messageIds?.length) {
    return Response.json({ ok: true, skipped: 'Preview was already sent', dateKey, messageIds: alreadySent.messageIds });
  }
